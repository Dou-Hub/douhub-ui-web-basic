...
const Tags = (props: {
    ...
    const tagClassName = `cursor-pointer float-left flex h-5 items-center mb-1 rounded-lg whitespace-nowrap bg-gray-50 border-gray-100 mr-2 px-1 my-1 leading-none self-center px-2 py-1 shadow hover:shadow-md ${isNonEmptyString(props.tagClassName) ? props.tagClassName : ''}`;
